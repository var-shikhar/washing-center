import{c as s,j as e,h as x,g as m,r as v,e as r,L as g,q as f,O as u}from"./index-DkidKY7D.js";import{L as t}from"./layout-C7enXjvf.js";import{I as j}from"./input-ET1Ogpp1.js";import{S as y}from"./separator-Vuz3HsiP.js";import{T as N}from"./theme-switch-CmwJWacc.js";import{U as k}from"./user-nav-Bu-GyEHD.js";import{S as M,a as I,b as S,c as w,e as b}from"./select-dqCVHQmV.js";import"./dropdown-menu-CKjr6Fii.js";import"./index-stKcZIEz.js";import"./index-C0CCeTT2.js";import"./index-DPfxzuVq.js";import"./index-sqcCN2LW.js";import"./index-oe18SB1a.js";import"./commonFn-D_Qiadkl.js";import"./index-BAGnQKRI.js";import"./index-BlF_HEDA.js";/**
 ...
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */var U=s("outline","user","IconUser",[["path",{d:"M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0",key:"svg-0"}],["path",{d:"M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2",key:"svg-1"}]]);function V(){return e.jsx("div",{children:e.jsx(j,{type:"search",placeholder:"Search...",className:"md:w-[100px] lg:w-[300px]"})})}function B({className:i,items:l,...n}){const{pathname:c}=x(),o=m(),[h,d]=v.useState(c??"/settings"),p=a=>{d(a),o(a)};return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"p-1 md:hidden",children:e.jsxs(M,{value:h,onValueChange:p,children:[e.jsx(I,{className:"h-12 sm:w-48",children:e.jsx(S,{placeholder:"Theme"})}),e.jsx(w,{children:l.map(a=>e.jsx(b,{value:a.href,children:e.jsxs("div",{className:"flex gap-x-4 px-2 py-1",children:[e.jsx("span",{className:"scale-125",children:a.icon}),e.jsx("span",{className:"text-md",children:a.title})]})},a.href))})]})}),e.jsx("div",{className:"hidden w-full overflow-x-auto bg-background px-1 py-2 md:block",children:e.jsx("nav",{className:r("flex space-x-2 lg:flex-col lg:space-x-0 lg:space-y-1",i),...n,children:l.map(a=>e.jsxs(g,{to:a.href,className:r(f({variant:"ghost"}),c===a.href?"bg-muted hover:bg-muted":"hover:bg-transparent hover:underline","justify-start"),children:[e.jsx("span",{className:"mr-2",children:a.icon}),a.title]},a.href))})})]})}function $(){return e.jsxs(t,{fixed:!0,children:[e.jsxs(t.Header,{children:[e.jsx(V,{}),e.jsxs("div",{className:"ml-auto flex items-center space-x-4",children:[e.jsx(N,{}),e.jsx(k,{})]})]}),e.jsxs(t.Body,{className:"flex flex-col",children:[e.jsxs("div",{className:"space-y-0.5",children:[e.jsx("h1",{className:"text-2xl font-bold tracking-tight md:text-3xl",children:"Settings"}),e.jsx("p",{className:"text-muted-foreground",children:"Manage your account settings and set e-mail preferences."})]}),e.jsx(y,{className:"my-4 lg:my-6"}),e.jsxs("div",{className:"flex flex-1 flex-col space-y-8 md:space-y-2 md:overflow-hidden lg:flex-row lg:space-x-12 lg:space-y-0",children:[e.jsx("aside",{className:"top-0 lg:sticky lg:w-1/5",children:e.jsx(B,{items:P})}),e.jsx("div",{className:"flex w-full p-1 pr-4 md:overflow-y-hidden",children:e.jsx(u,{})})]})]})]})}const P=[{title:"Profile",icon:e.jsx(U,{size:18}),href:"/settings"},{title:"Account",icon:e.jsx(L,{size:18}),href:"/settings/account"},{title:"Appearance",icon:e.jsx(T,{size:18}),href:"/settings/appearance"},{title:"Notifications",icon:e.jsx(E,{size:18}),href:"/settings/notifications"},{title:"Display",icon:e.jsx(z,{size:18}),href:"/settings/display"},{title:"Error Example",icon:e.jsx(C,{size:18}),href:"/settings/error-example"}];export{$ as default};
