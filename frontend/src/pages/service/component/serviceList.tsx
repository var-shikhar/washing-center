...
const ServiceList = ({list, handleEdit, handleDelete, handleUpdate}: TServiceListProps) => {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="px-2 py-3 text-left font-bold text-xs text-white bg-black uppercase tracking-wider md:px-6">Service Name</th>
            <th className="px-2 py-3 text-left font-bold text-xs text-white bg-black uppercase tracking-wider md:px-6">Category</th>
