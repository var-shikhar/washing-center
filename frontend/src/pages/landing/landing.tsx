...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <section className="relative">
        <div className="container mx-auto my-24 flex flex-col gap-10 items-center">
          ...
          <div className="no-scrollbar grid gap-4 overflow-auto md:grid-cols-2 lg:grid-cols-3">
            {centerList?.length >0 && centerList?.map(item => (
              <div key={item.centerID} className='relative rounded-lg border p-4 hover:shadow-md'>
                ...
                <div>
                  ...
                  <Link to={'../center/list'}>
                    <Button className='my-2 flex gap-2' size={'sm'}  variant={'outline'} >
