...
import TrackBookingForm from './component/trackBooking'
  ...
  return (
    <div>
        ...
        <section className="">
            ...
            <div className="bg-[--deep-purple] border-0 text-white py-24 text-5xl text-center -mt-1">Track your Booking Online</div>
        </section>
        <TrackBookingForm />
