    ...
    return (
        <div className="relative mt-16 bg-[--deep-purple]">
            <svg className="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16" preserveAspectRatio="none" viewBox="0 0 1440 54">
                <path fill="#020715" d="M0 22L120 16.7C240 11 480 1.00001 720 0.700012C960 1.00001 1200 11 1320 16.7L1440 22V54H1320C1200 54 960 54 720 54C480 54 240 54 120 54H0V22Z"></path>
            </svg>
            <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 text-slate-500">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-5">
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <div className="flex">
                            <a href="tel:9818059661" aria-label="Our phone" title="Our phone" className="transition-colors hover:text-slate-300 duration-300  hover:text-deep-purple-800">9818059661</a>
                        </div>
                        <div className="flex">
                            <a href="mailto:unnattechnologyservices@gmail.com" aria-label="Our email" title="Our email" className="transition-colors hover:text-slate-300 duration-300  hover:text-deep-purple-800">unnattechnologyservices@gmail.com</a>
                        </div>
                        <div className="flex">
